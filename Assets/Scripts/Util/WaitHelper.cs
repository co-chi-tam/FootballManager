...
public class WaitHelper {
	...
	private static WaitForSeconds m_WaitForSlightSeconds = new WaitForSeconds (0.1f);
	public static WaitForSeconds WaitForSlightSeconds {
		get { 
			return m_WaitForSlightSeconds;
		}
	}
